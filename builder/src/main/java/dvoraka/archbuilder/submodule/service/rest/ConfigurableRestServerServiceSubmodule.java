...
public class ConfigurableRestServerServiceSubmodule implements ServiceSubmodule, TemplateHelper {
    ...
    public ConfigurableRestServerServiceSubmodule(
            Class<?> superService,
    ...
    public void addSubmoduleTo(Directory srcBase) {
        ...
        String serviceName = helper.restServerServiceName();
        String serviceImplName = helper.restServerServiceImplName();
